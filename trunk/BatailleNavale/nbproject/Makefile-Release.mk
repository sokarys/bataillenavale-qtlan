...
${OBJECTDIR}/BateauCase.o: BateauCase.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BateauCase.o BateauCase.cpp
...
${OBJECTDIR}/BateauCasePleine.o: BateauCasePleine.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BateauCasePleine.o BateauCasePleine.cpp

${OBJECTDIR}/Partie.o: Partie.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Partie.o Partie.cpp
...
${OBJECTDIR}/BateauCaseVide.o: BateauCaseVide.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/BateauCaseVide.o BateauCaseVide.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/bataillenavale
